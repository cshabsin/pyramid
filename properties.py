...
PROPERTIES = {
    ...
    'DJOSER':     lambda w: w.find('CH') != -1,
    'HAWARA':     lambda w: cshabsin.CharacterTypeHandler.most_common_count(w, 'BCDFGHJKLMNPQRSTVWXYZ') >= 3,
    'KHUI':       lambda w: w[-1] == 'S',
    ...
    'MEIDUM':     lambda w: len(jtwang.DistinctHandler.distinct_vowels(w)) == 1,
    'MENKAURE':   None,
    'MERENRE':    None,
    'NEFEREFRE':  None,
    'NURI':       None,
